...
def trecereCLasaSuperioara(numeDat, lista):
    ...
    for rezervare in lista:
        if numeDat is getNume(rezervare):
...
def trecereCLasaInferioara(numeDat, lista):
    '''
        trecerea rezervarilor facute pe un nume dat la o clasa inferioara
        ;param substringNume: string
        ;param lista: lista de rezervari
        return: lista cu rezervari dupa modificarea claselor
        '''
    ...
    for rezervare in lista:
        if numeDat is getNume(rezervare):
            raise ValueError("Nu exista o rezervare cu numele dat")
        if getNume(rezervare) == numeDat and getClasa(rezervare) == "economy plus":
            rezervareNoua = creeazaRezervare(
                getId(rezervare),
                getNume(rezervare),
                "economy",
            ...
            listaNoua.append(rezervareNoua)
        elif getNume(rezervare) == numeDat and getClasa(rezervare) == "business":
            rezervareNoua = creeazaRezervare(
                getId(rezervare),
                getNume(rezervare),
                "economy plus",
            ...
            listaNoua.append(rezervareNoua)
        elif getClasa(rezervare) == "economy":
            listaNoua.append(rezervare)
        else:
            listaNoua.append(rezervare)
